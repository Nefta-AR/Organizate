  ...
  final List<Map<String, String>> _avatarOptions = [
    {
      'label': 'Emoticon',
      'value': 'emoticon',
      'image': 'assets/avatars/emoticon.png'
    },
    ...
    {'label': 'Rana', 'value': 'rana', 'image': 'assets/avatars/rana.png'},
    {
      'label': 'Pinguino',
      'value': 'pinguino',
      'image': 'assets/avatars/pinguino.png'
    },
    {
      'label': 'Unicornio',
      'value': 'unicornio',
      'image': 'assets/avatars/unicornio.png'
    },
  ];
  ...
  Future<void> _goToNextStep() async {
    ...
    try {
      ...
      await userDocRef.set({
        ...
        'preferredReminders': selectedReminderNames,
        'goalLength': _selectedGoalLength,
        'points': 1200,
  ...
  Widget _buildAvatarOptions() {
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onTap: () => _selectAvatar(option['value']!),
          child: Container(
