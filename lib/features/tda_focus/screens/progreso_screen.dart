    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          final double maxY = categoryCounts.values
                ...
                AspectRatio(
                  ...
                  child: BarChart(
                    BarChartData(
                      ...
                      barGroups: [
                        _buildBar(
                            0, categoryCounts['Estudios'] ?? 0, Colors.orange),
                        _buildBar(
                            1, categoryCounts['Hogar'] ?? 0, Colors.green),
                        _buildBar(2, categoryCounts['Meds'] ?? 0, Colors.red),
                        _buildBar(
                            3, categoryCounts['Foco'] ?? 0, Colors.purple),
                        _buildBar(
                            4, categoryCounts['General'] ?? 0, Colors.grey),
                      ],
                    ),
                  ),
                ),
