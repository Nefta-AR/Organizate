...
class _MedsScreenState extends State<MedsScreen> {
  ...
  void initState() {
    super.initState();
    try { _dateFormatter = DateFormat('dd MMM, HH:mm', 'es_ES'); } 
    catch (e) { _dateFormatter = DateFormat('dd MMM, HH:mm'); }
  }
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onLongPress: () => _showTaskOptionsDialog(
                    context, taskId, currentText, 'Meds', currentDueDate, reminderMinutes), // <-- CAMBIADO
                child: _buildGoalItem(
                  ...
                  onDonePressed: () async {
                      // Batch compartido para puntos y racha.
