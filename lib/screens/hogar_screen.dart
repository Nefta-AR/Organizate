  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Colors.green, // <-- CAMBIADO: Color Verde de Hogar
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        stream: tasksCollection
            .where('category', isEqualTo: 'Hogar') // <-- CAMBIADO: Filtro por 'Hogar'
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) { 
            debugPrint('¡¡¡ERROR EN FIREBASE (HOGAR): ${snapshot.error}!!!');
            return const Center(child: Text('Error al cargar tareas')); 
          }
          
          // Mensaje específico si no hay tareas de HOGAR
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) { 
            return const Center(child: Padding( 
              padding: EdgeInsets.all(32.0), 
              child: Text('No tienes tareas de hogar.\n¡Añade una con el botón +!', // <-- CAMBIADO
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onLongPress: () => _showTaskOptionsDialog(context, taskId, currentText, 'Hogar', currentDueDate), // <-- CAMBIADO
      ...
      builder: (BuildContext context) {
        return StatefulBuilder(
          builder: (context, setDialogState) {
            return AlertDialog(
              title: const Text('Nueva Tarea de Hogar'), // <-- CAMBIADO: Título específico
              content: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    // No necesitamos selector de categoría, ya es 'Hogar'
                    Row(
                      children: [
                        Expanded(
                          child: Text(
                        ...
                        IconButton(
                          icon: const Icon(Icons.calendar_today, color: Colors.green), // <-- CAMBIADO: Color de Hogar
                          onPressed: () async {
                  ...
                  onPressed: () {
                    if (taskController.text.isNotEmpty) {
                      ...
                      Map<String, dynamic> taskData = {
                        ...
                        'category': fixedCategory, // <-- Guarda "Hogar"
                        'iconName': iconName,
                        'colorName': colorName,
                        'done': false,
